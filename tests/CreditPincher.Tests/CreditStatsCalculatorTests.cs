...
namespace CreditPincher.Tests
{
    ...
    public class CreditStatsCalculatorTests
    {
        ...
        {
            var stats = CreditStatsCalculator.Calculate(
                new[] { Entry("2026-07-01T09:00:00Z", 20.0) },
                new DateOnly(2026, 7, 1),
                new DateOnly(2026, 7, 10),
                310.0,
                Utc);
        ...
        {
            var stats = CreditStatsCalculator.Calculate(
                new[] { Entry("2026-07-31T09:00:00Z", 10.0) },
                new DateOnly(2026, 7, 1),
        ...
        {
            var stats = CreditStatsCalculator.Calculate(
                new[] { Entry("2026-07-05T09:00:00Z", 5.0) },
                new DateOnly(2026, 7, 10),
                new DateOnly(2026, 7, 1),
                null,
                Utc);
        ...
        {
            var stats = CreditStatsCalculator.Calculate(
                new[] { Entry("2026-07-03T09:00:00Z", 8.0) },
                new DateOnly(2026, 7, 1),
        ...
        {
            return new CreditUsageEntry(DateTimeOffset.Parse(timestamp).ToUniversalTime(), amount);
        }
    }
}
